...
interface CompanyDetailContentClientProps {
...
export default function CompanyDetailContentClient({
  children,
  initialChatOpen,
  initialChatSize,
  companyName,
}: CompanyDetailContentClientProps) {
  // Chat panel state
  ...
  return (
    <div className="flex-1 min-h-0">
      <PanelGroup
        ...
        className="h-full"
      >
        {/* Company Detail Content Panel - NO TRANSITION for instant resize */}
        <Panel
          ...
          <>
            ...
            >
              <ChatPanel
                ...
                headerTitle="Company analysis"
                description={`Ask me anything about ${companyName}'s performance, financials, or market position.`}
