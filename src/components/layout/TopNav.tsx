...
export default function TopNav({ onToggleChat, isChatOpen }: TopNavProps) {
  return (
    <div className="sticky top-0 z-50 w-full">
      <div className="flex justify-between items-center py-3 px-6 w-full bg-[#0a1264]">
        ...
        <div className="flex flex-shrink-0 justify-end items-center gap-2">
          <Link href={ROUTES.NOTIFICATIONS} className="relative">
            ...
            <svg width={36} height={36} viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect width={36} height={36} rx={18} fill="#C7DCEF" />
            </svg>
          </Link>
        </div>
      </div>
